	...
	<!-- Put IE into quirks mode -->
		<html>
			...
			<body>
				<xsl:apply-templates />
				<div id="footer">
                                    <p>We would like to especially thank the organisers and funders of the <a href="http://www.biohackaton.org">BioHackathon</a> series of meetings for hosting the original discussions leading to NANDO</p> 
                                    <p>NANDO is addittionaly supported by:</p>
                                    <ul>
                                      <li><a href="http://biosciencedbc.jp/en/">National Bioscience Database Center (NBDC)</a> of <a href="http://www.jst.go.jp/">Japan Science and Technology Agency (JST)</a></li>
                                      <li><a href="http://dbcls.rois.ac.jp/en/">Database Center for Life Science (DBCLS)</a></li>
                                      <li><a href="http://www.rois.ac.jp/">Research Organization of Information and Systems (ROIS)</a></li>
	...
	<xsl:template match="rdf:RDF">
		<table id="header">
			<tr>
				...
				<td id="menu">
					<a href="http://nanbyodata.jp/ontology/nando.ttl">Turtle</a>
					&#183; <!-- middot -->
					<a href="http://nanbyodata.jp/ontology/nando.rdf">RDF/XML</a>
                                        &#183; <!-- middot -->
					<a href="https://github.com/aidrd/nando">GitHub/Documentation</a>
				</td>
			</tr>
		</table> <!-- end of header -->
                 <table id="search">
...
>>>>>>> e82f4da9479a2f3e195637e8da3da5454a1db783
